...
import InquiryPage from './sources/components/inquiryPage/inquiryPage';
import InquireService from './sources/services/inquire';
...
const inquireService = new InquireService(baseURL);
