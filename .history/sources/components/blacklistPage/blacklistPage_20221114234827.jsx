  ...
  return (
    <View style={[headerStyle, styles.container]}>
      ...
      <View style={styles.main}>
        <ScrollView>
          <View style={styles.userSecEX}>
            <View style={styles.userInformEX}>
              <Text style={styles.userInformTextEX}>유저 이름</Text>
            </View>
            <View style={styles.unlockBlackBtnEX}>
              <Text style={styles.unlockBlackBtnTextEX}></Text>
            </View>
          </View>
            ...
            blacklistArr.map((opponentUser) => (
              <View style={styles.userSec} key={opponentUser.uid}>
                <Pressable style={styles.userInform}>
                  <Text style={styles.userInformText}>{opponentUser.name}</Text>
                </Pressable>
                <Pressable
                  style={styles.unlockBlackBtn}
                  onPress={() => {
                    userDataService
                      .removeBlacklist(userData.uid, opponentUser.uid)
                      .then((data) => {
                        setIsLoading(true);
                        userDataService
                          .getBlacklist(userData.uid)
