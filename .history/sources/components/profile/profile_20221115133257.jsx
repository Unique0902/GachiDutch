          ...
          <ScrollView>
            ...
            <View style={styles.reviewSec}>
              <Pressable
                ...
                onPress={() => {
                  navigation.navigate('ReviewDetail', { reviewDataArr });
                }}
              >
              ...
              {reviewDataArr && reviewDataArr.length > 3 && (
                <>
                  <ReviewOne
                    reviewData={reviewDataArr[0]}
                    key={reviewDataArr[0].roomId}
                    navigation={navigation}
                  />
                  <ReviewOne
                    reviewData={reviewDataArr[1]}
                    key={reviewDataArr[1].roomId}
                    navigation={navigation}
                  />
                  <ReviewOne
                    reviewData={reviewDataArr[2]}
                    key={reviewDataArr[2].roomId}
                    navigation={navigation}
                  />
                </>
              )}
