...
const ReceiptDetail = ({ route, navigation }) => {
  ...
  return (
    <Pressable style={[headerStyle, styles.container]}>
      ...
      <View style={styles.main}>
        <ScrollView>
          ...
          <View style={styles.promiseSec}>
            {receipt.loc && (
              <Text style={styles.promiseLoc}>
                {`${receipt.loc.startLoc}에서 ${receipt.loc.arriveLoc까지}`}
              </Text>
            )}
            ...
            <Pressable
              style={styles.promiseInform}
              onPress={() => {
                navigation.navigate('Profile', {
                  userData: receipt.opponentUser,
                  setUserData: null,
                  isMe: false,
                });
              }}
          ...
          <View style={styles.promiseDetailSec}>
            <View style={styles.myDetailSec}>
              ...
              <Text style={styles.detailContentText}>
                {receipt.startAddress}
              </Text>
              <Text style={styles.detailTitleText}>
                내가 설정한 출발 원 반지름
              </Text>
              <Text style={styles.detailContentText}>{`${receipt.srad}m`}</Text>
              <Text style={styles.detailTitleText}>
                내가 설정한 도착 중심 주소
              </Text>
              <Text style={styles.detailContentText}>
                {receipt.arriveAddress}
              </Text>
              <Text style={styles.detailTitleText}>
                내가 설정한 도착 원 반지름
              </Text>
              <Text style={styles.detailContentText}>{`${receipt.arad}m`}</Text>
            </View>
          </View>
          <View style={styles.btnSec}>
            ...
            >
              <Text style={styles.reviewBtnText}>후기 작성</Text>
            </Pressable>
            <Pressable
