      ...
      <View style={styles.scroll}>
        <ScrollView>
          ...
          <View style={styles.evaluationSec}>
            ...
            >
              <View style={[styles.checkBox, checkedStyle(isChecked1)]}></View>
            ...
            >
              <View style={[styles.checkBox, checkedStyle(isChecked2)]}></View>
            ...
            >
              <View style={[styles.checkBox, checkedStyle(isChecked3)]}></View>
