      ...
      <View style={styles.scroll}>
        <ScrollView>
          ...
          <View style={styles.selectSec}>
            <Pressable style={[styles.selectBtn, checkedStyle(isSelected1)]}>
              <Text style={styles.selectText}>매너 평가하기</Text>
            </Pressable>
            <Pressable style={[styles.selectBtn, checkedStyle(isSelected2)]}>
              <Text>비매너 평가하기</Text>
            </Pressable>
          </View>
          ...
          <Pressable style={[styles.applyBtn, applyBtnStyle()]}>
            <Text style={[styles.applyText, applyTextStyle()]}>
              후기 남기기
            </Text>
          </Pressable>
        </ScrollView>
