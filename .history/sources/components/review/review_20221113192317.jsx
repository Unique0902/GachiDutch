...
const Review = ({ userDataService, route, navigation }) => {
  ...
  useEffect(() => {
    if (!isChecked1 && !isChecked2 && !isChecked3 && isLeast2) {
          ...
          {isSelected1 && (
            <>
              ...
              <View style={styles.reviewSec}>
                ...
                />
                {!isLeast2 && (
                  <Text style={styles.warnText}>2자 이상 입력해주세요!</Text>
                )}
              </View>
              {!praiseData && !isPraiseData && (
                <Pressable
                  ...
                  onPress={() => {
                    if (!isLoading1 && isCanApply1) {
                      setIsLoading1(true);
                      userDataService
                        .updatePraiseData(
                          receipt.opponentUser.uid,
                          isChecked1,
                          isChecked2,
                          isChecked3,
                          receipt.roomId,
              ...
              {!blameData && !isBlameData && (
                ...
                >
                  {isLoading3 ? (
                    ...
                    <Text
                      style={[styles.applyText, applyTextStyle(isCanApply2)]}
                    >
                      후기 남기기
                    </Text>
                  )}
