      ...
      <View style={styles.scroll}>
        <ScrollView>
          ...
          <View style={styles.evaluationSec}>
            <Pressable style={styles.evaluationTitleSec}>
          ...
          <View style={styles.reviewSec}>
            <Pressable style={styles.reviewTitleSec}>
            ...
            <View style={styles.review}>
              ...
              <View style={styles.reviewMain}>
                <View style={styles.reviewInform}>
                  <Text style={styles.reviewUserNameText}>코카콜라</Text>
                  <Text style={styles.reviewTimeText}>2022/02/01</Text>
                </View>
                <Text style={styles.reviewText}>감사합니다 ^^</Text>
              </View>
            </View>
            <View style={styles.review}>
              <Image style={styles.reviewUserImage} />
              <View style={styles.reviewMain}>
                <View style={styles.reviewInform}>
                  <Text style={styles.reviewUserNameText}>라떼는 말이야</Text>
                  <Text style={styles.reviewTimeText}>2022/02/01</Text>
                </View>
                <Text style={styles.reviewText}>잘 했네요 ^^</Text>
              </View>
            </View>
          </View>
        </ScrollView>
