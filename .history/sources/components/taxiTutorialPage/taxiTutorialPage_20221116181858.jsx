...
import { hadFirstTaxi } from '../../services/asyncstorage';
      ...
      <View style={styles.main}>
        {pageNum == 1 && (
          <View style={styles.page}>
            <Pressable
              ...
              onPress={() => {
                hadFirstTaxi().then((data) => {
                  navigation.navigate('Taxi', {
                    userData,
                    coming: 'taxiTutorialPage',
                  });
                });
              }}
            >
        ...
        {pageNum == 4 && (
          <View style={styles.page}>
            ...
            <Image
              resizeMode='stretch'
              source={require('../../images/fourth.jpeg')}
              style={styles.tutorialImg}
            />
            <View style={styles.btns}>
              <Pressable
        ...
        {pageNum == 5 && (
          <View style={styles.page}>
            ...
            <Image
              resizeMode='stretch'
              source={require('../../images/fifth.jpeg')}
              style={styles.tutorialImg}
            />
            <View style={styles.btns}>
              <Pressable
        ...
        {pageNum == 6 && (
          <View style={styles.page}>
            ...
            <Image
              resizeMode='stretch'
              source={require('../../images/sixth.jpeg')}
              style={styles.tutorialImg}
            />
            <View style={styles.btns}>
              <Pressable
        ...
        {pageNum == 7 && (
          <View style={styles.page}>
            ...
            <Image
              resizeMode='stretch'
              source={require('../../images/seventh.jpeg')}
              style={styles.tutorialImg}
            />
            <View style={styles.btns}>
              <Pressable
        ...
        {pageNum == 8 && (
          <View style={styles.page}>
            ...
            <Image
              resizeMode='stretch'
              source={require('../../images/eightth.jpeg')}
              style={styles.tutorialImg}
            />
            <View style={styles.btns}>
              <Pressable
        ...
        {pageNum == 9 && (
          <View style={styles.page}>
            ...
            <Image
              resizeMode='stretch'
              source={require('../../images/nineth.jpeg')}
              style={styles.tutorialImg}
            />
            <View style={styles.btns}>
              <Pressable
        ...
        {pageNum == 10 && (
          <View style={styles.page}>
            <Image
              resizeMode='stretch'
              source={require('../../images/tenth.jpeg')}
              style={styles.tutorialImg}
            />
            <View style={styles.bigBtns}>
              <Pressable
                style={styles.beforeBtn}
                onPress={() => {
                  setPageNum(pageNum - 1);
              ...
              >
                <Text style={styles.nextBtnText}>시작하러가기</Text>
              </Pressable>
            </View>
          </View>
        )}
