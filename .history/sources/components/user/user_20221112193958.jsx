  ...
  return (
    <View style={[styles.container, headerStyle]}>
      ...
      <Pressable
        ...
        onPress={() => {
          navigation.navigate('Profile', { userData, setUserData });
        }}
      >
        <View onPress={onProfilePress}>
      ...
      <View style={styles.menus}>
        <ScrollView>
          ...
          >
            <Text style={styles.menuText}>친구목록 관리</Text>
            <AntDesign style={styles.enter} name='right' size={20} />
          </Pressable>
          <Pressable
            style={styles.enterMenu}
          ...
          >
            <Text style={styles.menuText}>차단목록 관리</Text>
            <AntDesign style={styles.enter} name='right' size={20} />
          </Pressable>
          <Pressable
            style={styles.enterMenu}
            onPress={() => {
              navigation.navigate('Setting', { setUserData, setLogin, login });
            }}
          >
