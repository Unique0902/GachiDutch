...
import { isLogin } from '../../services/asyncstorage';
      ...
      <View style={{ flex: 14 }}>
        ...
        >
          <Tab.Screen
            ...
            children={({ navigation }) => (
              <Home login={login} setLogin={setLogin} navigation={navigation} />
            )}
          />
          <Tab.Screen
            name='Receipt'
            ...
            children={({ navigation }) => (
              <Receipt login={login} navigation={navigation} />
            )}
          />
          <Tab.Screen
            options={({ route, navigation }) => {
          ...
          <Tab.Screen
            ...
            name='User'
            children={({ navigation }) => (
              <User login={login} setLogin={setLogin} navigation={navigation} />
            )}
          />
        </Tab.Navigator>
      </View>
