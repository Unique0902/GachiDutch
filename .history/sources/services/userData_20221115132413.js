export default class UserDataService {
  ...
  updateReview = async (userId, review, roomId, writerUid, time) => {
  ...
  amendReview = async (userId, review, roomId, writerUid, time) => {
    const data = await fetch(`${this.http}/userdata/review/amend`, {
      method: 'POST',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
