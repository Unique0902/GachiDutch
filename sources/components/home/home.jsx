...
import { isLogin, getUid, checkFirstTaxi } from '../../services/asyncstorage';
...
const Home = ({ login, setLogin, navigation, setUserData, userData }) => {
  ...
  return (
    <View style={[styles.home, headerStyle]}>
      <View style={styles.top}>
        ...
        <View style={styles.mainTop}>
          ...
          <View style={styles.advertisementBox}>
            ...
            >
              <Pressable
                style={[styles.advertisement, advertisementStyle()]}
                onPress={() => {
