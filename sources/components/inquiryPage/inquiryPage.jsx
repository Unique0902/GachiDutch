...
const InquiryPage = ({ inquireService, navigation, route }) => {
  ...
  return (
    <View style={[headerStyle, styles.container]}>
      ...
      <View style={styles.scroll}>
        ...
        />
        <Pressable
          style={[styles.inquireBtn, inquireBtnStyle(isCanSend)]}
          onPress={() => {
            if (isCanSend) {
              inquireService.createInquiry(
                titleText,
                contentText,
                userData.uid
              );
